...
- Current phase: **Phase 2 / Slice 2-A authorized**
- Phase 2 implementation: **MFO-WO-P2-2A-001 active / implementation pending**
...
- Active work order: [`../docs/work-orders/phase2-slice2a-basic-operation.md`](../docs/work-orders/phase2-slice2a-basic-operation.md)
...
`MFO-WO-P2-2A-001`に従い、`10`が8方向移動・独立aimを維持したauthority ground stepとsame-arena reset
seamだけを実装し、handoff後に`30`が検証する。物理gamepad証跡はOD-013を維持したままGate Playability
まで延期し、KBM結果でPassへ置き換えない。正式な快斬・重断、損傷、HUD統合、素材、魔法、boss、stageは
別work orderまで着手しない。
