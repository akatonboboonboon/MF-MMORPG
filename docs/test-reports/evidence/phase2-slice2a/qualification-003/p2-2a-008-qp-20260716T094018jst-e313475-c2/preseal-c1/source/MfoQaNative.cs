...
namespace MfoQaQualification
{
    ...
    public static class RunnerRole
    {
        ...
        private static Dictionary<string, object> AuditPreackContractBinding(RoleContext c, string identity)
        {
            ...
            int start = source.IndexOf(preackStart, StringComparison.Ordinal);
            ...
            int liveStart = source.IndexOf(liveStartMarker, StringComparison.Ordinal);
            ...
            int launcherClass = source.IndexOf(launcherClassMarker, StringComparison.Ordinal);
