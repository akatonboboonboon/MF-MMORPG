...
00  User explicitly approved MFO-WO-P2-2B-014
 ↓
10  MFO-WO-P2-2B-014 stopped after the exact source correction on an ignored scratch-helper syntax defect
 ↓
00  MFO-WO-P2-2B-015 active: exact helper replacement and remaining implementation verification
 ↓
