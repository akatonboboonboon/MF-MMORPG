...
30  MFO-WO-P2-2B-011 returned Blocked before parser; FORMAL and Stage B candidate execution remained 0
 ↓
00  User explicitly authorized safe resumption; MFO-WO-P2-2B-012 issued with qualified capture
 ↓
30  MFO-WO-P2-2B-012: one consolidated runner batch, capture qualification, one parser, and one FORMAL invocation
```
