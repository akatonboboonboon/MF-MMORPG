...
30  MFO-WO-P2-2B-011 returned Blocked before parser; FORMAL and Stage B candidate execution remained 0
 ↓
00  User explicitly authorized safe resumption; MFO-WO-P2-2B-012 issued
 ↓
30  MFO-WO-P2-2B-012 returned Blocked at first capture qualification; parser／FORMAL／candidate execution remained 0
 ↓
00  Stage B validation Deferred; no active Slice 2-B QA order; Gate 2 remains Locked
```
